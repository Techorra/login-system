...
class Login:
    def __init__(self, root):
        ...
        self.root.geometry("1290x630+0+0")
    ...
    def loginform(self):
        ...
        self.img = ImageTk.PhotoImage(file="backgrounds-2.jpg")
        ...
        frame_input.place(x=500, y=150, height=450, width=350)
    ...
    def login(self):
        ...
        if self.email_txt.get() == "" or self.password.get() == "":
            ...
            try:
                ...
                cur.execute('select * from register where email_id=%s and password=%s',
    ...
    def Register(self):
        ...
        img = Label(Frame_login1, image=self.img).place(
            x=0, y=0, width=1366, height=700)
        ...
        label4 = Label(frame_input2, text="Email", font=("Goudy old style", 20, "bold"),
    ...
    def register(self):
        ...
        if self.entry.get() == "" or self.entry2.get() == "" or self.entry3.get() == "" or self.entry4.get() == "":
            ...
            try:
                ...
                cur.execute(
                    "select * from register where email_id=%s", self.entry3.get())
    ...
    def appscreen(self):
        ...
        label1 = Label(Frame_login, text="Hi! Welcome to Login-Form", font=('times new roman', 32, 'bold'),
